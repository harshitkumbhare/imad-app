...
var config = {
    user: 'harshitkumbhare',
    database: 'harshitkumbhare',
...
var articles = {
    'article-one': {
    title: 'Article One | Harshit Kumbhare',
    heading: 'Article One',
    date: 'August 04, 2017',
    content: 
            `<p>
    ...
    'article-two': {
    title: 'Article Two | Harshit Kumbhare',
    heading: 'Article Two',
    date: 'August 05, 2017',
    content: 
            `<p>
    ...
    'article-three': {
    title: 'Article Three | Harshit Kumbhare',
...
app.get('/test-db',function(req,res){
    ...
    pool.query('SELECT * FROOM test', function (err,result){
        if (err){
